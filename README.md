...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV16ia6epENY?p=64)
...
### 3.1.1技术可行性
本高校学科竞赛平台采用SSM框架，JAVA作为开发语言，是基于WEB平台的B/S架构系统。
...
|jingsaineirong|varchar(200)|是|NULL|竞赛内容|
|jingsaishijian|varchar(200)|是|NULL|竞赛时间|
|didian|varchar(200)|是|NULL|地点|
|jibie|varchar(200)|是|NULL|级别|
...
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|jingsaimingcheng|varchar(200)|是|NULL|竞赛名称|
|duiming|varchar(200)|是|NULL|队名|
|cansaichengyuan|varchar(200)|是|NULL|参赛成员|
|jingfeiyusuan|varchar(200)|是|NULL|经费预算|
|cansaifeiyong|varchar(200)|是|NULL|参赛费用|
...
|jibie|varchar(200)|是|NULL|级别|
|duiming|varchar(200)|是|NULL|队名|
|cansaichengyuan|longtext|是|NULL|参赛成员|
|zhanghao|varchar(200)|是|NULL|账号|
|xingming|varchar(200)|是|NULL|姓名|
|sfsh|varchar(200)|是|否|是否审核|
|shhf|longtext|是|NULL|审核回复|
...
|duiming|varchar(200)|是|NULL|队名|
|cansaichengyuan|longtext|是|NULL|参赛成员|
|yusuan|longtext|是|NULL|预算|
|xiangmu|longtext|是|NULL|项目|
...
|zuopin|varchar(200)|是|NULL|作品|
|zuopintese|longtext|是|NULL|作品特色|
表4.6 成绩申诉
...
|jingsaimingcheng|varchar(200)|是|NULL|竞赛名称|
|jingsaileixing|varchar(200)|是|NULL|竞赛类型|
|chengji|varchar(200)|是|NULL|成绩|
|shensuyuanyin|varchar(200)|是|NULL|申诉原因|
|xueshengzhanghao|varchar(200)|是|NULL|学生账号|
|xueshengxingming|varchar(200)|是|NULL|学生姓名|
|zhanghao|varchar(200)|是|NULL|账号|
|xingming|varchar(200)|是|NULL|姓名|
...
|duiming|varchar(200)|是|NULL|队名|
|cansaichengyuan|longtext|是|NULL|参赛成员|
|renshu|varchar(200)|是|NULL|人数|
|huojiangjine|int(11)|是|NULL|获奖金额|
|huojiangmingxi|longtext|是|NULL|获奖明细|
...
|duiming|varchar(200)|是|NULL|队名|
|cansaichengyuan|varchar(200)|是|NULL|参赛成员|
|zuopinpingfen|varchar(200)|是|NULL|作品评分|
...
|timu|longtext|是|NULL|题目|
|timuleixing|varchar(200)|是|NULL|题目类型|
|wenjian|varchar(200)|是|NULL|文件|
表4.13 竞赛信息
...
|jingsaimingcheng|varchar(200)|是|NULL|竞赛名称|
|jingsaileixing|varchar(200)|是|NULL|竞赛类型|
|jingsaimude|longtext|是|NULL|竞赛目的|
|jingsaineirong|longtext|是|NULL|竞赛内容|
|jingsaishijian|date|是|NULL|竞赛时间|
|didian|longtext|是|NULL|地点|
|jibie|varchar(200)|是|NULL|级别|
|jubandanwei|varchar(200)|是|NULL|举办单位|
|chengbandanwei|varchar(200)|是|NULL|承办单位|
...
|duiming|varchar(200)|是|NULL|队名|
|cansaichengyuan|varchar(200)|是|NULL|参赛成员|
|jingsaizongjie|varchar(200)|是|NULL|竞赛总结|
|wenjian|varchar(200)|是|NULL|文件|
|zhanghao|varchar(200)|是|NULL|账号|
|xingming|varchar(200)|是|NULL|姓名|
表4.15 晋级名单
...
|xingming|varchar(200)|是|NULL|姓名|
|xingbie|varchar(200)|是|NULL|性别|
|jiaogonghao|varchar(200)|是|NULL|教工号|
|xueyuan|varchar(200)|是|NULL|学院|
|zhuanyelingyu|longtext|是|NULL|专业领域|
|shouji|varchar(200)|是|NULL|手机|
|youxiang|varchar(200)|是|NULL|邮箱|
|touxiang|varchar(200)|是|NULL|头像|
表4.17 竞赛资讯
...
|duiming|varchar(200)|是|NULL|队名|
|cansaichengyuan|longtext|是|NULL|参赛成员|
|lingduijiaoshi|varchar(200)|是|NULL|领队教师|
表4.21 学生
...
|xueyuan|varchar(200)|是|NULL|学院|
|canyujingsai|varchar(200)|是|NULL|参与竞赛|
|shouji|varchar(200)|是|NULL|手机|
|youxiang|varchar(200)|是|NULL|邮箱|
|touxiang|varchar(200)|是|NULL|头像|
表4.22 学院
...
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|xueyuan|varchar(200)|是|NULL|学院|
|xueyuanjianjie|longtext|是|NULL|学院简介|
|tupian|varchar(200)|是|NULL|图片|
表4.23 专业
